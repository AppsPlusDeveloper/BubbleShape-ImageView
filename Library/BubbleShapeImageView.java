package com.erickc.bubbleshape.imageview;
...
public class BubbleShapeImageView extends ImageView {
	...
	public BubbleShapeImageView(Context context) {
		super(context);
		initView(null);
	}

	public BubbleShapeImageView(Context context, AttributeSet attrs, int defStyle) {
		super(context, attrs, defStyle);
		initView(attrs);
	}

	public BubbleShapeImageView(Context context, AttributeSet attrs) {
		super(context, attrs);
		initView(attrs);
	}
	...
	private void initView(AttributeSet attrs) {
		if (attrs != null) {
			TypedArray a = getContext().obtainStyledAttributes(attrs,
					R.styleable.BubbleShapeImageView);
			mAngle = (int) a.getDimension(
					R.styleable.BubbleShapeImageView_bubble_angle, mAngle);
			mArrowHeight = (int) a.getDimension(
					R.styleable.BubbleShapeImageView_bubble_arrowHeight,
					mArrowHeight);
			mArrowOffset = (int) a.getDimension(
					R.styleable.BubbleShapeImageView_bubble_arrowOffset,
					mArrowOffset);
			mArrowTop = (int) a.getDimension(
					R.styleable.BubbleShapeImageView_bubble_arrowTop, mArrowTop);
			mArrowWidth = (int) a.getDimension(
					R.styleable.BubbleShapeImageView_bubble_arrowWidth, mAngle);
			mArrowLocation = a.getInt(
					R.styleable.BubbleShapeImageView_bubble_arrowLocation,
					mArrowLocation);
			a.recycle();
		}
	}
